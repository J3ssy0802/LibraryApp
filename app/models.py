...
class Member(Base):
    ...
    loans: Mapped[List['Loan']] = db.relationship(back_populates='member', cascade='all, delete')
...
class Item(Base):
    ...
    order_items: Mapped[List['OrderItems']] = db.relationship(back_populates='item', cascade='all, delete')
...
class Order(Base):
    ...
    order_items: Mapped[List['OrderItems']] = db.relationship(back_populates='order', cascade='all, delete')
